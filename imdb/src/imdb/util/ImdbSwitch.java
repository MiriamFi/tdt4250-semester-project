...
public class ImdbSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ImdbPackage.TV_SERIES: {
				TvSeries tvSeries = (TvSeries)theEObject;
				T result = caseTvSeries(tvSeries);
				if (result == null) result = caseTitle(tvSeries);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ImdbPackage.EPISODE: {
				...
				if (result == null) result = caseTitle(episode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ImdbPackage.TITLE_TYPE_WRAPPER: {
				TitleTypeWrapper titleTypeWrapper = (TitleTypeWrapper)theEObject;
				T result = caseTitleTypeWrapper(titleTypeWrapper);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseTvSeries(TvSeries object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Title Type Wrapper</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Title Type Wrapper</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTitleTypeWrapper(TitleTypeWrapper object) {
		return null;
	}
